...
namespace Swashbuckle.AspNetCore.ApiTesting
{
    public class JsonOneOfValidator : IJsonValidator
    {
        ...
        public bool CanValidate(OpenApiSchema schema) => schema.OneOf != null;
        ...
        public bool Validate(OpenApiSchema schema, JToken instance, out IEnumerable<string> errorMessages)
        {
            ...
            {
                if (_jsonValidator.Validate(oneOfArray[i], instance, out IEnumerable<string> subErrorMessages))
                    matched++;
                else
